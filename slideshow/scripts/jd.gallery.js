...
leftArrow.addClass('left').addEvent('click',this.prevItem.bind(this)).injectInside(element);


rightArrow.addClass('right').addEvent('click',this.nextItem.bind(this)).injectInside(element);
...
this.carouselBtn.set('html', textShowCarousel);
this.prepareTimer();
...
this.ReMooz.close(); //added to close full screen image. 
},
prevItem: function() {
...
isCarouselOpen = true;  //added for swipe features
},
...
isCarouselOpen = false; //added for swipe features
},
